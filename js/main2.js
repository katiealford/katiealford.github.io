...
$(function(){
  $("#pieChart").drawPieChart([
    { title: "Advertising",    value : 50,   color: "rgba(240, 255, 250, .25)" },
    { title: "Environmental",  value : 25,   color: "rgba(240, 255, 250, .25)" },
    { title: "Freelance",      value : 25,   color: "rgba(240, 255, 250, .25)" }
  ]);
});
